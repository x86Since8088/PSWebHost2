...
<body>
    <div class="placeholder">
        ...
        <p>Connect to and manage Redis cache instances.</p>

        <div class="feature-list">
            <h4>Planned Features:</h4>
            <ul>
                <li>Connection management</li>
                <li>Key browser and search</li>
                <li>Value viewer/editor (String, Hash, List, Set, ZSet)</li>
                <li>Server statistics and monitoring</li>
                <li>CLI command interface</li>
            </ul>
        </div>
    </div>
</body>
...
"@
    ...
    Write-PSWebHostLog -Severity 'Error' -Category 'RedisManager' -Message "Error: $($_.Exception.Message)"
