...
# Sample status endpoint for Redis Manager app
try {
    $result = @{
        app = 'Redis Manager'
        version = '1.0.0'
    ...
    Write-PSWebHostLog -Severity 'Error' -Category 'RedisManager' -Message "Error in status endpoint: $($_.Exception.Message)"
