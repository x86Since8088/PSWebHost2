...
# Sample status endpoint for Docker Manager app
try {
    $result = @{
        app = 'Docker Manager'
        version = '1.0.0'
    ...
    Write-PSWebHostLog -Severity 'Error' -Category 'DockerManager' -Message "Error in status endpoint: $($_.Exception.Message)"
