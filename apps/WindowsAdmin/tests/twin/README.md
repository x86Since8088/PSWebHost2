# WindowsAdmin Twin Tests

Comprehensive tests for the WindowsAdmin app.
...
### All Tests
```powershell
.\WindowsAdmin.Tests.ps1 -TestMode All
```

### CLI Tests Only
```powershell
.\WindowsAdmin.Tests.ps1 -TestMode CLI
```

### Integration Tests Only
```powershell
.\WindowsAdmin.Tests.ps1 -TestMode Integration
```

### Browser Tests
1. Start PSWebHost: pwsh WebHost.ps1
2. Navigate to: http://localhost:8888/apps/unittests/api/v1/ui/elements/unit-test-runner
3. Select "WindowsAdmin Browser Tests"
4. Click "Run Tests"
