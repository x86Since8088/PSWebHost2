...
// Define test suite
const MySQLManagerBrowserTests = {
    suiteName: 'MySQLManager Browser Tests',
    version: '1.0.0',
    author: 'PSWebHost',
    ...
    async testAPIEndpoint() {
        const response = await fetch('/apps/MySQLManager/api/v1/status');
    ...
    async testLocalStorage() {
        const testKey = 'MySQLManager_test';
    ...
    async testErrorHandling() {
        ...
        try {
            await this.apiCall('/apps/MySQLManager/api/v1/nonexistent');
...
if (typeof window.TestSuites !== 'undefined') {
    window.TestSuites.register(MySQLManagerBrowserTests);
    console.log(`[TestSuite] Registered: ${MySQLManagerBrowserTests.suiteName}`);
} else {
...
if (typeof module !== 'undefined' && module.exports) {
    module.exports = MySQLManagerBrowserTests;
}
