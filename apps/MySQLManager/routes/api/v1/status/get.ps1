...
# Sample status endpoint for MySQL Manager app
try {
    $result = @{
        app = 'MySQL Manager'
        version = '1.0.0'
    ...
    Write-PSWebHostLog -Severity 'Error' -Category 'MySQLManager' -Message "Error in status endpoint: $($_.Exception.Message)"
