/**
 * uPlot Area Chart Component
 * Filled area charts for cumulative data visualization
 */
...
class AreaChartComponent extends HTMLElement {
    ...
    initializeLogger() {
        ...
        if (typeof ConsoleAPILogger !== 'undefined') {
            ...
            this.logger = { info: (...args) => console.log('[area-chart:info]', ...args), warn: (...args) => console.warn('[area-chart:warn]', ...args), error: (...args) => console.error('[area-chart:error]', ...args), debug: (...args) => console.debug('[area-chart:debug]', ...args), verbose: (...args) => console.log('[area-chart:verbose]', ...args) };
        }
    }
    ...
    async initializeChart() {
        this.logger.info('Initializing area chart');
    ...
    buildSeriesConfig(metadata) {
        ...
        // Add data series with fills for area chart
    ...
    disconnectedCallback() {
        ...
        this.logger?.info('Area Chart Component destroyed');
    }
}

// Register custom element
customElements.define('area-chart', AreaChartComponent);


// Also register as a React component for SPA compatibility
if (typeof window.cardComponents !== 'undefined') {
    window.cardComponents['area-chart'] = ({ element, url }) => {
        const React = window.React;
        const ref = React.useRef(null);

        React.useEffect(() => {
            if (ref.current && !ref.current.querySelector('area-chart')) {
                const component = document.createElement('area-chart');
