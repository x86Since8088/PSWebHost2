# KubernetesManager Twin Tests

Comprehensive tests for the KubernetesManager app.
...
### All Tests
```powershell
.\KubernetesManager.Tests.ps1 -TestMode All
```

### CLI Tests Only
```powershell
.\KubernetesManager.Tests.ps1 -TestMode CLI
```

### Integration Tests Only
```powershell
.\KubernetesManager.Tests.ps1 -TestMode Integration
```
