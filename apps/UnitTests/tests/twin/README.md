# UnitTests Twin Tests

Comprehensive tests for the UnitTests app.

## Description
Browser-based twin test runner for PSWebHost with real-time execution, coverage tracking, and process leak detection

## Running Tests

### All Tests
```powershell
.\UnitTests.Tests.ps1 -TestMode All
```

### CLI Tests Only
```powershell
.\UnitTests.Tests.ps1 -TestMode CLI
```

### Integration Tests Only
```powershell
.\UnitTests.Tests.ps1 -TestMode Integration
```
