...
// Define test suite
const SQLServerManagerBrowserTests = {
    suiteName: 'SQLServerManager Browser Tests',
    version: '1.0.0',
    author: 'PSWebHost',
    ...
    async testLocalStorage() {
        const testKey = 'SQLServerManager_test';
...
if (typeof window.TestSuites !== 'undefined') {
    window.TestSuites.register(SQLServerManagerBrowserTests);
    console.log(`[TestSuite] Registered: ${SQLServerManagerBrowserTests.suiteName}`);
} else {
...
if (typeof module !== 'undefined' && module.exports) {
    module.exports = SQLServerManagerBrowserTests;
}
