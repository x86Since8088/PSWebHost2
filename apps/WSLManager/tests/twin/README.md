# WSLManager Twin Tests

Comprehensive tests for the WSLManager app.
...
### All Tests
```powershell
.\WSLManager.Tests.ps1 -TestMode All
```

### CLI Tests Only
```powershell
.\WSLManager.Tests.ps1 -TestMode CLI
```

### Integration Tests Only
```powershell
.\WSLManager.Tests.ps1 -TestMode Integration
```
