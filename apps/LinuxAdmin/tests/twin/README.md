# LinuxAdmin Twin Tests

Comprehensive tests for the LinuxAdmin app.

## Description
Linux services, cron jobs, and system management

## Running Tests

### All Tests
```powershell
.\LinuxAdmin.Tests.ps1 -TestMode All
```

### CLI Tests Only
```powershell
.\LinuxAdmin.Tests.ps1 -TestMode CLI
```

### Integration Tests Only
```powershell
.\LinuxAdmin.Tests.ps1 -TestMode Integration
```

### Browser Tests
1. Start PSWebHost: pwsh WebHost.ps1
2. Navigate to: http://localhost:8888/apps/unittests/api/v1/ui/elements/unit-test-runner
3. Select "LinuxAdmin Browser Tests"
4. Click "Run Tests"
